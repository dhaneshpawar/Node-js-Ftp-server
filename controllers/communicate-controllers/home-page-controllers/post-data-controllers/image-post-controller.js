...
{
    app.post('/postimagecommunicate', urlencodedParser , function(req,res)
    {
        ...
        upload(req,res,(err)=>
        {
            ...
            {
            console.log(profileImageExtension)
                //inserting the user uploaded file and name and lastname into the databse 
                var postimageurl = 'uploads/communicate/post/' + postid + "." + profileImageExtension;
                var postcomment = req.body.imagecomment;
                              ...
                              else
                              {
                                ...
                                else
                                {
                                 ...
                                 console.log("------- emitted the event -------")
                                  ...
                                  io.to(data[0].socket).emit('newpost',mypost);         
                                }
                              }
                            });
